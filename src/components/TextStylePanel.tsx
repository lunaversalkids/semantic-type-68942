...
export const TextStylePanel = ({
  ...
  const formattingModes = ['Normal', 'Single Spacing', '1.5 Spacing', '2.5 Spacing', 'Hanging Indent'];
  ...
  return <aside className="w-[340px] h-full bg-sidebar border-l border-sidebar-border flex flex-col overflow-hidden relative">
      ...
      <ScrollArea showScrollbar={false} className="flex-1 p-2.5 pt-[72px] [&_[data-radix-scroll-area-viewport]]:scrollbar-none [&_[data-radix-scroll-area-viewport]]:[-ms-overflow-style:none] [&_[data-radix-scroll-area-viewport]]:[-webkit-overflow-scrolling:touch] [&_[data-radix-scroll-area-viewport]]:scroll-smooth">
