               ...
               <div className="w-full border-t border-[hsl(253,60%,88%)]">
                <div className="relative pt-3 pb-1">
                  ...
                  <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 z-10 flex-shrink-0 w-5 h-5 flex items-center justify-center bg-white border border-[hsl(253,100%,30%)]/30 rounded-[3px] hover:bg-[hsl(253,100%,64%)]/20 hover:border-[hsl(253,100%,64%)] transition-all duration-200"
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 z-10 flex-shrink-0 w-5 h-5 flex items-center justify-center bg-white border border-[hsl(253,100%,30%)]/30 rounded-[3px] hover:bg-[hsl(253,100%,64%)]/20 hover:border-[hsl(253,100%,64%)] transition-all duration-200"
                    aria-label="Next category"
                  >
                    <ChevronRight className="w-3 h-3 text-[hsl(253,100%,30%)]" strokeWidth={2.5} />
                  </button>
                  
                  {/* Scrollable Container with Plus Icon and Categories */}
                  <div ref={scrollContainerRef} className="overflow-x-auto overflow-y-hidden scrollbar-hide px-10">
